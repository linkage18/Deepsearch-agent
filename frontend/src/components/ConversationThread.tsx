...
const TASK_EXAMPLES = [
  {
    ...
    title: "公开资料补充",
    prompt:
      "请使用公开学术资料搜索助手，检索 ReAct 论文的公开资料、项目主页和后续工作，并附上来源链接。",
  ...
  },
  {
    ...
    title: "论文元数据筛选",
    prompt:
      "请使用论文元数据查询助手，查询 2023 年以来与 Tool Use 和 Reflection 相关的论文，列出标题、年份、会议和论文链接。",
  ...
  },
  {
    ...
    title: "论文正文证据",
    prompt:
      "请使用论文知识库研读助手，从本地论文库中检索 ReAct 的核心方法、实验设置和局限性，并保留来源片段。",
  ...
  },
  {
    ...
    title: "上传文件分析",
    prompt:
      "请使用文件读取工具，读取我上传的论文 PDF 或阅读笔记，提炼研究问题、方法、实验结论和待核验证据。",
  ...
  },
  {
    ...
    title: "生成交付报告",
    prompt:
      "请基于本次论文调研结果生成一份 Markdown 综述报告，并转换成 PDF 保存到当前工作目录。",
    ...
    <article className="chat-message chat-message--assistant">
      ...
      <div className="message-bubble">
        <div className="message-meta">
          <span>Paper Research Agent</span>
          <time>{syncLabel}</time>
        </div>
      ...
      <div className="conversation-empty">
        <div className="empty-examples">
          <div className="empty-examples-copy">
            ...
            <h3>选择一个论文调研任务开始</h3>
            <p>
              每个示例会触发不同资料来源，检索证据、执行轨迹和输出文件会直接出现在对话里。
            </p>
          </div>

          <div className="example-grid" aria-label="论文调研任务示例">
